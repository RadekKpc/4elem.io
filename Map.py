    ...
    def player_eat_player(self):
        for p1 in self.players:
            for p2 in self.players:
                if self.players[p1].score>self.players[p2].score and self.players[p1].can_eat_player(self.players[p2]): #check wchich ball is bigger and if it is possible to eat it
